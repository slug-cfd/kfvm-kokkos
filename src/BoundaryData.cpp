...
BoundaryData::BoundaryData(const ProblemSetup &ps)
  ...
  if (ps.layoutMPI.wDst != MPI_PROC_NULL) {
    ...
    wFaceSend =
        FaceDataPinnedView("Solver::BoundaryData::wFaceSend", KFVM_DM_DECL(ps.nY, ps.nZ));
  }
  ...
  if (ps.layoutMPI.wSrc != MPI_PROC_NULL) {
    wCellRecv = ConsDataPinnedView("Solver::BoundaryData::wCellRecv",
                                   KFVM_D_DECL(ps.rad, ps.nY, ps.nZ));
    wFaceRecv =
        FaceDataPinnedView("Solver::BoundaryData::wFaceRecv", KFVM_DM_DECL(ps.nY, ps.nZ));
  }
  ...
  if (ps.layoutMPI.eDst != MPI_PROC_NULL) {
    eCellSend = ConsDataPinnedView("Solver::BoundaryData::eCellSend",
                                   KFVM_D_DECL(ps.rad, ps.nY, ps.nZ));
    eFaceSend =
        FaceDataPinnedView("Solver::BoundaryData::eFaceSend", KFVM_DM_DECL(ps.nY, ps.nZ));
  }
  ...
  if (ps.layoutMPI.eSrc != MPI_PROC_NULL) {
    eCellRecv = ConsDataPinnedView("Solver::BoundaryData::eCellRecv",
                                   KFVM_D_DECL(ps.rad, ps.nY, ps.nZ));
    eFaceRecv =
        FaceDataPinnedView("Solver::BoundaryData::eFaceRecv", KFVM_DM_DECL(ps.nY, ps.nZ));
  }
  ...
  if (ps.layoutMPI.sDst != MPI_PROC_NULL) {
    ...
    sFaceSend =
        FaceDataPinnedView("Solver::BoundaryData::sFaceSend", KFVM_DM_DECL(ps.nX, ps.nZ));
  }
  ...
  if (ps.layoutMPI.sSrc != MPI_PROC_NULL) {
    sCellRecv = ConsDataPinnedView("Solver::BoundaryData::sCellRecv",
                                   KFVM_D_DECL(ps.nX + 2 * ps.rad, ps.rad, ps.nZ));
    sFaceRecv =
        FaceDataPinnedView("Solver::BoundaryData::sFaceRecv", KFVM_DM_DECL(ps.nX, ps.nZ));
  }
  ...
  if (ps.layoutMPI.nDst != MPI_PROC_NULL) {
    nCellSend = ConsDataPinnedView("Solver::BoundaryData::nCellSend",
                                   KFVM_D_DECL(ps.nX + 2 * ps.rad, ps.rad, ps.nZ));
    nFaceSend =
        FaceDataPinnedView("Solver::BoundaryData::nFaceSend", KFVM_DM_DECL(ps.nX, ps.nZ));
  }
  ...
  if (ps.layoutMPI.nSrc != MPI_PROC_NULL) {
    nCellRecv = ConsDataPinnedView("Solver::BoundaryData::nCellRecv",
                                   KFVM_D_DECL(ps.nX + 2 * ps.rad, ps.rad, ps.nZ));
    nFaceRecv =
        FaceDataPinnedView("Solver::BoundaryData::nFaceRecv", KFVM_DM_DECL(ps.nX, ps.nZ));
  }

  if (ps.layoutMPI.bDst != MPI_PROC_NULL) {
    bCellSend =
        ConsDataPinnedView("Solver::BoundaryData::bCellSend",
                           KFVM_D_DECL(ps.nX + 2 * ps.rad, ps.nY + 2 * ps.rad, ps.rad));
    bFaceSend =
        FaceDataPinnedView("Solver::BoundaryData::bFaceSend", KFVM_DM_DECL(ps.nX, ps.nY));
  }

  if (ps.layoutMPI.bSrc != MPI_PROC_NULL) {
    bCellRecv =
        ConsDataPinnedView("Solver::BoundaryData::bCellRecv",
                           KFVM_D_DECL(ps.nX + 2 * ps.rad, ps.nY + 2 * ps.rad, ps.rad));
    bFaceRecv =
        FaceDataPinnedView("Solver::BoundaryData::bFaceRecv", KFVM_DM_DECL(ps.nX, ps.nY));
  }

  if (ps.layoutMPI.tDst != MPI_PROC_NULL) {
    tCellSend =
        ConsDataPinnedView("Solver::BoundaryData::tCellSend",
                           KFVM_D_DECL(ps.nX + 2 * ps.rad, ps.nY + 2 * ps.rad, ps.rad));
    tFaceSend =
        FaceDataPinnedView("Solver::BoundaryData::tFaceSend", KFVM_DM_DECL(ps.nX, ps.nY));
  }

  if (ps.layoutMPI.tSrc != MPI_PROC_NULL) {
    tCellRecv =
        ConsDataPinnedView("Solver::BoundaryData::tCellRecv",
                           KFVM_D_DECL(ps.nX + 2 * ps.rad, ps.nY + 2 * ps.rad, ps.rad));
    tFaceRecv =
        FaceDataPinnedView("Solver::BoundaryData::tFaceRecv", KFVM_DM_DECL(ps.nX, ps.nY));
  }
}
